...
public class Main {
  ...
  public static void pathToLeafFromRoot(Node node, String path, int sum, int lo, int hi){
    ...
    if(newSum <= hi && newSum >= lo){
        if(node.left == null && node.right == null) System.out.println(newPath);
    }
    pathToLeafFromRoot(node.left, newPath, newSum, lo, hi);
    pathToLeafFromRoot(node.right, newPath, newSum, lo, hi);
