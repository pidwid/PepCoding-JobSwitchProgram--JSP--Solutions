...
public class Main {
  ...
  public static void linearize(Node node){
     while(node.children.size() > 1){
        ...
        Node tail = node.children.get(size - 1);
        Node last = node.children.get(size);
  ...
  */
  ...
  public static void linearize(Node node){
    ...
    while(node.children.size() > 1){
        Node SLTail = getTail(node.children.get(node.children.size() - 2));
  ...
  public static Node linearizeEfficient(Node node){
    ...
    while(node.children.size() > 1){
        Node SLTail = linearizeEfficient(node.children.get(node.children.size() - 2));
        Node last = node.children.get(node.children.size() - 1);
        SLTail.children.add(last);
        node.children.remove(node.children.size() - 1);
    } 
